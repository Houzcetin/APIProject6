...
namespace APIProject6.WebUI.Controllers
{
    public class ReservationController : Controller
    {
        ...
        public async Task<IActionResult> ReservationList()
        {
            ...
            var responseMessage = await client.GetAsync("https://localhost:7277/api/Reservations");
        ...
        public async Task<IActionResult> CreateReservation(CreateReservationDto createReservationDto)
        {
            ...
            var responseMessage = await client.PostAsync("https://localhost:7277/api/Reservations", stringContent);
        ...
        {
            var client = _httpClientFactory.CreateClient();
            await client.DeleteAsync("https://localhost:7277/api/Reservations?id=" + id);
            return RedirectToAction("ReservationList");
        }
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.GetAsync("https://localhost:7277/api/Reservations/GetReservation?id=" + id);
            var jsonData = await responseMessage.Content.ReadAsStringAsync();
