...
namespace APIProject6.WebUI.Models
{
    public class ChatHub : Hub
    {
        private readonly IConfiguration _configuration;
        private const string modelGpt = "gpt-5.4-mini";
        ...
        {
            var apiKey = _configuration["OpenAI:ChatBotApiKey"];
            if (string.IsNullOrWhiteSpace(apiKey))
            {
                throw new InvalidOperationException("OpenAI ChatBot API key is missing.");
            }
